...
public interface IAdoptionViewRepo extends IGenericRepo<AdoptionView, UUID> {
    @Query(value = "SELECT a.adoption_date, a.adoption_id, a.application_id, a.profile_name, a.profile_last_name, a.pet_id, a.pet_name, a.shelter_id, a.shelter_name, a.user_id\n" +
            "\tFROM adoption_view a\n" +
